...
public class ProductServiceTest extends BaseTest {
    ...
    public void testModifyProduct() throws Exception{
        ...
        product.setShop(shop);
        product.setProductCategory(pc);
        product.setProductName("更新扬州炒饭");
        product.setProductDesc("更新扬州炒饭描述");

        File thumbnailFile = new File("C:\\Users\\Administrator\\Desktop\\校园商铺\\images\\item\\shop\\15\\2017060523302118864.jpg");
        InputStream is = new FileInputStream(thumbnailFile);
        ImageHolder thumbnail = new ImageHolder(thumbnailFile.getName(),is);

        File productImg1 = new File("C:\\Users\\Administrator\\Desktop\\校园商铺\\images\\item\\shop\\15\\20170605233022246642.jpg");
        InputStream is1 = new FileInputStream(productImg1);
        File productImg2 = new File("C:\\Users\\Administrator\\Desktop\\校园商铺\\images\\item\\shop\\15\\20170605233021865310.jpg");
        InputStream is2 = new FileInputStream(productImg2);
        List<ImageHolder> productImgList = new ArrayList<>();
        productImgList.add(new ImageHolder(productImg1.getName(),is1));
        productImgList.add(new ImageHolder(productImg2.getName(),is2));
